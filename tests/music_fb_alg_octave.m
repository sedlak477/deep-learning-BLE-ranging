...
function [dist_MUSIC,spec_dB,peakwidth] = music_fb_alg_octave(M,nsig,Nptot,dists,cal_dist,...
...
[~,locs,peakwidth,~] = findpeaks_compat(spec(1,:),'MinPeakHeight',spec_T); % Sorted by peakage magnitude. Excluding negative delays.
